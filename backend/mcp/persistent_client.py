...
class PersistentMCPConnection:
    """A persistent connection to a single MCP server with advanced features."""
...
class PersistentMCPManager:
    """Manages multiple persistent MCP connections."""
    
    def __init__(self):
        self.connections: Dict[str, PersistentMCPConnection] = {}
    ...
    async def add_server(self, config: MCPServerConfig) -> bool:
        ...
        async with self._lock:
            ...
            connection = PersistentMCPConnection(config)
...
async def get_persistent_mcp_manager() -> PersistentMCPManager:
    """Get or create the global persistent MCP manager."""
    global persistent_mcp_manager
    
    if persistent_mcp_manager is None:
        persistent_mcp_manager = PersistentMCPManager()
        await persistent_mcp_manager.initialize_default_servers()
    
    return persistent_mcp_manager
